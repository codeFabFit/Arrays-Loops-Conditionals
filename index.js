...
// this keeps giving me an error saying results is not defined 
// function fizzbuzz(n) {
//     let results = [];
...
//  fizzbuzz();
 ...
 //this one works but got infinite loop 
// Wild Wild Life
...
// // plantee[2] +=1;
// // console.log(plantee);
// // // // now plantee is 1 year older
// wolfy.push("Gotham City")
// console.log(wolfy)
// // // // // wolfy is now from Gotham City & dart ihas additional Hawkins
// // dart.push("Hawkins")
// // console.log(dart)
// wolfy[0] = "Gameboy";
// console.log(wolfy)
// // wolfy is now Gameboy
...
//     console.log(index)
//     if (index == 0){console.log("...human... why you taking pictures of me...?")} else if (index == 1) { console.log("...the catnip made me do it...") } else {
...
//     return 0;
// }
// const sum = numbers.reduce((total, numbers) => total + numbers, 0);
